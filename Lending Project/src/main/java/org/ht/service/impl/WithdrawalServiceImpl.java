...
public class WithdrawalServiceImpl implements WithdrawalService{
	...
	public Map<String, Object>  withdrawallist(String currpage,String btn,Map<String, Object> findmap) {
		...
		int totalrow = wdao.withdrawalcount(ma);//total row
	...
	public int intmoney(Withdrawal w,int i) {
		...
		if(i==0){
		map.put("what", "Withdrawal failed");
		}else if(i==1){
			map.put("what", "Transfer failed");
		}else if(i==2){
			map.put("what", "Successful transfer");
		}
