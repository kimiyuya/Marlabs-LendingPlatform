...
public class InvestStat extends BaseDomain {
	...
	*/
	...
	private int isid;// 'Investment information statistics table primary key',
	private int userid;// 'Investment user primary key',
	private int markcount;// 'Total bids',
	private int lmcount;// 'Total Missed',
	private int gmcount;// 'Total bids',
	private BigDecimal markmoney;// 'Total investment',
	private BigDecimal markgain;// 'Total investment income',
	private Timestamp markbegindate;// 'Investment start time',
	private Timestamp markenddate;// 'Investment end time'
