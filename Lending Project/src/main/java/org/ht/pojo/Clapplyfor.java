...
//	 `clpid`   'application id',
//	  `clpubcid`   'username',
//	  `clpuname`   'user's name',
//	  `clpporiginal`  'Original credit',
//	  `clpidpaper`  'ID photo',
//	  `clphpoc`   'Property certificate photos',
//	  `clpf`  'Apply for credit',
//	  `clpdate`  'application time',
//	  `clpauditor`  'Follow up audit',
//	  `clpstate`  'states',
